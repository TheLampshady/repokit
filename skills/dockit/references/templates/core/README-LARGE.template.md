...
|-----------|---------|---------|
[COMPONENTS_TABLE_WITH_LINKS]

```mermaid
[SIMPLE_OVERVIEW_DIAGRAM]
```
...
[IF_COMPLEX_CICD]
> See [DEPLOYMENT.md](./docs/cloud/DEPLOYMENT.md) for CI/CD pipelines.
[ENDIF]
...
- [STANDARD_1]
- [STANDARD_2]
- Run tests before submitting: `[TEST_COMMAND]`
