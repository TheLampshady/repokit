...
| **Architectural hotspot** | high | high (≥ 2) | high | Add to `FOUNDATIONS.md` as `status: active` with `health: hotspot`, and report the churn — the abstraction may be wrong or carrying too much. |
