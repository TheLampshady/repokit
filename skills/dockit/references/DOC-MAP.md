...
**Purpose:** Catalog of shared/foundational code with invariants, consumers, and refactor triggers. Source of truth for `agentkit` — per-foundation subagents that own these foundations and carry their invariants in hot memory.
